...
//        
//        const int imageSize = boarderBox.getWidth() / 4.5;
//        float scaleFor3DEffect;
//        if(isSideView){
//            scaleFor3DEffect = - sinf(spherical.azimuth * M_PI / 180.0) * cosf(spherical.elevation * M_PI / 180.0) * spherical.distance;
//        }else{
//            scaleFor3DEffect = spherical.distance * sinf(spherical.elevation * M_PI / 180.);
...
//                g.drawImage(headSideImage, boarderBox.getCentreX()-imageSize/2, boarderBox.getCentreY()-imageSize/2 - 1, imageSize, imageSize, 0, 0, 200, 200);
...
//    //    }
//    //
//    void pixelToSpherical(){
//        
//        //float x, y, z;
//        if(isSideView){
//            Rectangle<float> bounds = getLocalBounds().toFloat();
//            float normY = pixel.x / bounds.getWidth(); // 0 - 1
...
//            
//            if(d < 1.0){
//                spherical.distance = d * r2;
//            }else{
//                spherical.distance = ((d-1)/(r-1) + 1) * r2;
...
//            pixel.set(bounds.getCentreX() + normY * bounds.getWidth()/2.0, bounds.getCentreY() + normZ * bounds.getHeight()/2.0);
//        }else{
//            Rectangle<float> bounds = getLocalBounds().toFloat();
...
//                if(!mouseInComponent){ //to prevent redundant calls
//                    //            if(isSideView)
