...
package com.yourcompany.sofapanremote;
...
//==============================================================================
public class SofaPanRemote   extends Activity
{
    //==============================================================================
    static
    {
               ...
               .setOnCancelListener (new DialogInterface.OnCancelListener()
                    {
                        ...
                        {
                            SofaPanRemote.this.alertDismissed (callback, 0);
                        }
                    })
               ...
               .setPositiveButton (okButtonText.isEmpty() ? "OK" : okButtonText, new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.dismiss();
                            SofaPanRemote.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.dismiss();
                            SofaPanRemote.this.alertDismissed (callback, 2);
                        }
                    })
